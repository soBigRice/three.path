...
(function (global, factory) {
	...
	function generateTubeVertexData(pathPointList, options, generateUv2 = false) {
		...
		function addVertices(pathPoint) {
			...
			const A = centerPosition.clone().add(up.clone().multiplyScalar(halfHeight)).add(right.clone().multiplyScalar(-halfWidth));
			const A1 = centerPosition.clone().add(up.clone().multiplyScalar(halfHeight)).add(right.clone().multiplyScalar(-halfWidth));
			const B = centerPosition.clone().add(up.clone().multiplyScalar(halfHeight)).add(right.clone().multiplyScalar(halfWidth));
			const B1 = centerPosition.clone().add(up.clone().multiplyScalar(halfHeight)).add(right.clone().multiplyScalar(halfWidth));
			const C = centerPosition.clone().add(up.clone().multiplyScalar(-halfHeight)).add(right.clone().multiplyScalar(halfWidth));
			const C1 = centerPosition.clone().add(up.clone().multiplyScalar(-halfHeight)).add(right.clone().multiplyScalar(halfWidth));
			const D = centerPosition.clone().add(up.clone().multiplyScalar(-halfHeight)).add(right.clone().multiplyScalar(-halfWidth));
			const D1 = centerPosition.clone().add(up.clone().multiplyScalar(-halfHeight)).add(right.clone().multiplyScalar(-halfWidth));
	...
	exports.PathRectangleGeometry = PathRectangleGeometry;
